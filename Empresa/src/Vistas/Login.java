...
public class Login extends javax.swing.JFrame {
    ...
    /**
     * @author Cristhian Padilla
     * Se inicia el singleton de login
     * tambien creamos el controlador de la instancia para que sea un singleton 
     */
    ...
    public static Login getLogin(){
        //Para evitar que se creen más de una instancia
        if(login==null)
            login=new Login();
    ...
    private void olvidoMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_olvidoMouseEntered
        // Color azul cuanto el cursor esta sobre el texto 
    ...
    private void olvidoMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_olvidoMouseExited
        // Color negro cuando el mouse no esta tocando el texto
        
        olvido.setForeground(new java.awt.Color(0, 0, 0));
    }//GEN-LAST:event_olvidoMouseExited

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // Muestra en caso de que sea correcta la contraseña si es correcta y en el caso contrario mostraria error 
